...
import { AdminPageShell, ShellStatCard } from '@infyenergy/pages/shared/PageShell';
import {
  useCustomerManagement,
  getManagementCategoryFromPath,
  ...
  return (
    <AdminPageShell
      ...
      tabPanels={tabLists.map((list, idx) => ({
        ...
        emptyText: tableSearch
          ? 'No matching records'
          : `No ${cfg.title.toLowerCase()} records found`,
      }))}
