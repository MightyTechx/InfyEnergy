...
import { Typography, Tabs, Divider, TextField, InputAdornment, Tooltip } from '@mui/material';
        ...
        {multiTypeStatCards ? (
          <Box
            ...
            sx={{
              gridTemplateColumns: {
                xs: 'repeat(2, 1fr)',
                sm: `repeat(${multiTypeStatCards.length}, 1fr)`,
              },
            }}
          >
            {multiTypeStatCards.map(
              ({
                label,
                value,
                Icon,
            ...
            {getFilteredData(list).length === 0 ? (
              <Box className={classes.emptyState}>
                ...
                <Typography variant='h6' color='text.secondary'>
                  {tableSearch
                    ? 'No matching records'
                    : `No ${cfg.title.toLowerCase()} requests found`}
                </Typography>
              </Box>
            ) : (
