...
import { AdminPageShell } from '@infyenergy/pages/shared/PageShell';
import {
  CUSTOMER_ACCESS_CONFIG,
  CustomerCategory,
} from '../CustomerAccess/hooks/useCustomerAccess';
  ...
  return [
    {
      ...
      description:
        'Review and approve mobility operator onboarding requests — two-wheelers, auto rickshaws, cabs, and shuttle services.',
      icon: DirectionsBusIcon,
      color: '#6366f1',
      path: p.MOBILITY_ACCESS,
    },
    {
      key: 'logistics',
      ...
      description:
        'Review logistics operator requests — Tata Ace, DCM, medium goods vehicles, and heavy truck operators.',
      icon: LocalShippingIcon,
      color: '#f59e0b',
      path: p.LOGISTICS_ACCESS,
    },
    {
      key: 'parcel',
      ...
      description:
        'Review parcel and last-mile delivery operator onboarding requests for documents, food, and goods delivery.',
      icon: Inventory2Icon,
      color: '#ea580c',
      path: p.PARCEL_ACCESS,
    },
    {
      key: 'driver-hire',
      ...
      description:
        'Review and approve driver hire service providers — dedicated drivers for personal, commercial, and fleet use.',
      icon: HailIcon,
      color: '#16a34a',
      path: p.DRIVER_HIRE_ACCESS,
    },
    {
      key: 'vehicle-rental',
      ...
      description:
        'Review vehicle rental operator onboarding requests for self-drive bookings and rental services.',
      icon: CarRentalIcon,
      color: '#7c3aed',
      path: p.VEHICLE_RENTAL_ACCESS,
    },
    {
      key: 'mechanic',
      ...
      description:
        'Review mechanic service provider requests — on-demand roadside assistance and scheduled vehicle servicing.',
      icon: BuildIcon,
      color: '#78350f',
      path: p.MECHANIC_ACCESS,
    },
    {
      key: 'petrol-bunk',
    ...
    },
    {
      ...
      description:
        'Review EV charging station partner onboarding — AC and DC fast chargers mapped for electric vehicle operators.',
      icon: EvStationIcon,
      color: '#059669',
      path: p.EV_CHARGING_ACCESS,
    },
    {
      key: 'showroom',
      ...
      description:
        'Review vehicle showroom and dealership partner requests — new and used vehicle listings connected to the platform.',
      icon: StoreIcon,
      color: '#1d4ed8',
      path: p.SHOWROOM_ACCESS,
    },
    {
      key: 'vehicle-finance',
      ...
      description:
        'Review vehicle finance institution onboarding — banks and NBFCs offering instant vehicle loans and EMI plans.',
      icon: AccountBalanceIcon,
      color: '#9333ea',
      path: p.VEHICLE_FINANCE_ACCESS,
    },
    {
      key: 'finance-broker',
      ...
      description:
        'Review finance broker and DSA agent onboarding requests — loan facilitators earning referral commissions.',
      icon: HandshakeIcon,
      color: '#0f766e',
      path: p.FINANCE_BROKER_ACCESS,
    },
    {
      key: 'insurance',
      ...
      description:
        'Review insurance provider onboarding — vehicle insurance, health cover, and driver protection plan providers.',
      icon: SecurityIcon,
      color: '#166534',
      path: p.INSURANCE_ACCESS,
    },
    {
      key: 'user',
    ...
    >
      ...
      <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mt: 0.5 }}>
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <Typography
            sx={{ fontWeight: 800, fontSize: '1.05rem', lineHeight: 1.2, pr: hasNotif ? 5 : 0 }}
          >
            {item.displayName}
          </Typography>
          <Typography
      ...
      >
        ...
        >
          <Typography sx={{ fontSize: '0.78rem', fontWeight: 700, color: item.color }}>
            {hasNotif ? 'Review Requests' : 'View Requests'}
          </Typography>
        ...
        {accessTypes
          ...
          .map((item) => (
            <AccessCard
              key={item.key}
              item={item}
              counts={counts[item.key] ?? { pending: 0, review: 0 }}
...
export const AccessView = () => {
  ...
  const fetchCounts = useCallback(async () => {
    try {
      ...
      setCounts(newCounts);
      setTotalPending(
        rows.filter((r) => r.status === 'pending' || r.status === 'under_review').length,
      );
    } catch {
      setCounts({});
    }
      ...
      {totalPending > 0 && (
        ...
        >
          ...
          <Typography sx={{ fontSize: '0.8rem', fontWeight: 700, color: '#ef4444' }}>
            {totalPending} requests awaiting review
          </Typography>
        </Box>
      )}
      <AccessSection
