...
import { Box, Button } from '@infyenergy/component';
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: fe('rc.expiry') as unknown as string,
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: fe('insurance.expiry') as unknown as string,
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: fe('puc.expiry') as unknown as string,
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: fe('fitness.expiry') as unknown as string,
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: fe('permit.expiry') as unknown as string,
                ...
                <DatePicker
                  ...
                  slotProps={{
                    textField: {
                      ...
                      helperText: fe('dl.expiry') as unknown as string,
                  ...
                  <DatePicker
                    ...
                    slotProps={{
                      textField: {
                        ...
                        helperText: fe('idProof.expiry') as unknown as string,
