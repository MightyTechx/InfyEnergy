...
import { Box, Button, TextField, Select } from '@infyenergy/component';
import { constants } from '@infyenergy/utils';
import { useFieldError, useAuth, useLocalStorage } from '@infyenergy/hooks';
import { useAuthActionMutation, useUploadUserAttachmentsMutation } from '@infyenergy/services';
            ...
            <DatePicker
              ...
              slotProps={{
                textField: {
                  ...
                  helperText: reqError(submitted && !form.dateOfBirth, 'required') as unknown as string,
                },
              }}
            />
      ...
      >
        ...
        >
          ...
          <Button
            ...
            onClick={() => {
              setSubmitted(true);
              if (canSubmit) setReviewOpen(true);
            }}
